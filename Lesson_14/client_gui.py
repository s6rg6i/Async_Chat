...
from constants import USER_LIST_OK, MESSAGE_OK, MESSAGE_LIST_OK, ROOM_LIST_OK
from jim_api import Jim, MessageParser
from chat_gui import MainWindow


class SockRecvSignal(QtCore.QThread):  # Мониторинг входящих сообщений от сервера
